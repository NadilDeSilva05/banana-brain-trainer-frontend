    ...
    >
      ...
      <main className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 py-8">
        <div className="w-full max-w-2xl space-y-6">
          ...
          {/* Welcome Message */}
          <div className="text-center space-y-1 animate-slide-in-up" style={{ animationDelay: '0.2s' }}>
              ...
              if (item.isLink) {
                return (
                  <Link
                    key={item.id}
                    href={item.href!}
                    className="group block rounded-xl bg-[#223632] p-5 transition-all duration-300 hover:bg-[#2a423d] hover:shadow-lg cursor-pointer transform hover:scale-105 hover:-translate-y-1 active:scale-95 animate-slide-in-left"
