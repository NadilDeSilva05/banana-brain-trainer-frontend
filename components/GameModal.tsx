...
export default function GameModal({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md mx-4 rounded-2xl bg-[#223632] shadow-2xl">
        {/* Modal Header */}
        <div className="px-6 py-4 border-b border-[#4CAF50]/30">
          <h3 className="text-xl font-bold text-white text-center">Your Score</h3>
          <p className="text-3xl font-bold text-[#4CAF50] text-center mt-2">{score}</p>
        </div>
        ...
        <div className="p-4 space-y-2">
          <button
            onClick={onContinue}
            className="w-full rounded-xl bg-[#1A2B27] px-6 py-4 text-left text-white hover:bg-[#2a423d] transition-colors border-2 border-transparent  flex items-center gap-4"
          >
          ...
          >
            ...
            <span className="text-lg font-semibold">Quit Game</span>
          </button>
        </div>
        ...
        <div className="px-4 pb-4">
          <button
            onClick={onClose}
            className="w-full rounded-xl bg-[#4CAF50] px-6 py-3 text-white font-semibold hover:bg-[#3bc66f] transition-colors"
          >
            Cancel
          </button>
        </div>
