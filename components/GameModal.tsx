    ...
    >
      <div className="relative w-full max-w-md mx-4 rounded-2xl bg-[#223632] shadow-2xl animate-modal-content">
        ...
        <div className="p-4 space-y-2">
          <button
            onClick={onContinue}
            className="w-full rounded-xl bg-[#1A2B27] px-6 py-4 text-left text-white hover:bg-[#2a423d] transition-all duration-300 border-2 border-transparent flex items-center gap-4 transform hover:scale-105 hover:shadow-lg animate-slide-in-left animate-delay-100"
          >
          ...
          <button
            onClick={onNewGame}
            className="w-full rounded-xl bg-[#1A2B27] px-6 py-4 text-left text-white hover:bg-[#2a423d] transition-all duration-300 border-2 border-transparent flex items-center gap-4 transform hover:scale-105 hover:shadow-lg animate-slide-in-left animate-delay-200"
          >
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#223632] border-2 border-[#4CAF50]">
          ...
          <button
            onClick={onMainMenu}
            className="w-full rounded-xl bg-[#1A2B27] px-6 py-4 text-left text-white hover:bg-[#2a423d] transition-all duration-300 border-2 border-transparent flex items-center gap-4 transform hover:scale-105 hover:shadow-lg animate-slide-in-left animate-delay-300"
          >
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#223632] border-2 border-[#4CAF50]">
          ...
          <button
            onClick={onLogout}
            className="w-full rounded-xl bg-[#1A2B27] px-6 py-4 text-left text-white hover:bg-[#2a423d] transition-all duration-300 border-2 border-transparent flex items-center gap-4 transform hover:scale-105 hover:shadow-lg animate-slide-in-left animate-delay-400"
          >
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#223632] border-2 border-[#4CAF50]">
