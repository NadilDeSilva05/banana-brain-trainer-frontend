    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm animate-modal-enter">
      <div className="relative w-full max-w-md mx-4 rounded-2xl bg-[#223632] shadow-2xl border-2 border-[#4CAF50]/30 animate-modal-content">
        ...
        <div className="px-6 pb-6 pt-4 space-y-3">
          <button
            onClick={onConfirm}
            className="w-full rounded-xl bg-[#4CAF50] px-6 py-4 text-white font-semibold hover:bg-[#3bc66f] transition-all duration-300 flex items-center justify-center gap-3 shadow-lg transform hover:scale-105 active:scale-95 animate-slide-in-up animate-delay-200"
          >
          ...
          <button
            onClick={onCancel}
            className="w-full rounded-xl bg-[#1A2B27] px-6 py-4 text-white font-semibold hover:bg-[#2a423d] transition-all duration-300 border-2 border-[#4CAF50]/30 flex items-center justify-center gap-3 transform hover:scale-105 hover:shadow-lg animate-slide-in-up animate-delay-300"
          >
